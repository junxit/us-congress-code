...
- **(d)** *Lead Inspector General for Overseas Contingency Operation.—*
  ...
  - **(5)** *Ccompetitive 33 So in original. status for appointment.—*
    ...
    - **(B)** *Limitation.—* No person who is first employed as described in subparagraph (A) more than 2 years after December 19, 2019,1 may acquire competitive status under subparagraph (A).
