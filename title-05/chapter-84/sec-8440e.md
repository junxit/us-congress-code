...
- **(d)**
  - **(1)**
    - **(A)** The amount contributed by a member described in section 211(a)(1) of title 37 for any pay period out of basic pay may not exceed the maximum percentage of such member’s basic pay for such pay period allowable under section 8440f.
