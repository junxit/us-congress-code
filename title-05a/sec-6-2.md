...
- **(a)** In addition to the authority otherwise provided by this Act, each Inspector General, in carrying out the provisions of this Act, is authorized—
  - **(1)**
    - **(A)** to have timely access to all records, reports, audits, reviews, documents, papers, recommendations, or other materials available to the applicable establishment which relate to the programs and operations with respect to which that Inspector General has responsibilities under this Act;
...
- **(h)**
  - **(1)** If the Inspector General of an establishment submits a request to the head of the establishment for Federal grand jury materials pursuant to subsection (a)(1), the head of the establishment shall immediately notify the Attorney General of such request.
  ...
  - **(3)**
    - **(A)** The head of the establishment shall inform the Inspector General of the establishment of the determination made by the Attorney General with respect to the request for Federal grand jury materials.
