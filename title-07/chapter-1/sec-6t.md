...
- **(a)** *Prohibition*
  - **(1)** *In general* Except as provided in paragraph (2), it shall be unlawful for any person to enter into any swap that the Commission determines to perform a significant price discovery function with respect to registered entities if—
