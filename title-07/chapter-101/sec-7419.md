...
- **(c)** *Civil penalties and orders*
  ...
  - **(5)** *Finality* An order assessing a penalty or a cease-and-desist order issued under this subsection by the Secretary shall be final and conclusive unless the person against whom the order is issued files an appeal from the order with the United States court of appeals, as provided in subsection (d) of this section.
