...
- **(f)** *Assessments*
  ...
  - **(4)** *Use of assessments*
    - **(A)** *In general* Subject to subparagraphs (B) and (C) and subsection (c)(5) of this section, the order shall provide that the assessments collected shall be used by the Board—
