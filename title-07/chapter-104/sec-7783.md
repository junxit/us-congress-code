...
- **(c)** *Use of grant funds; cost shares*
  - **(1)** *Use of grants* A weed management entity that receives a grant under subsection (a) of this section shall use the grant funds to carry out a project authorized by subsection (d) of this section for the control or eradication of a noxious weed.
  - **(2)** *Cost shares*
