...
- **(b)** *Effective price* For purposes of subsection (a) of this section, the effective price for a covered commodity is equal to the sum of the following:
...
- **(f)** *Time for payments*
  - **(1)** *General rule* If the Secretary determines under subsection (a) of this section that counter-cyclical payments are required to be made under this section for the crop of a covered commodity, the Secretary shall make the counter-cyclical payments for the crop as soon as practicable after the end of the 12-month marketing year for the covered commodity.
