...
- **(a)** *Permitted crops* Subject to subsection (b) of this section, any commodity or crop may be planted on the base acres for peanuts on a farm.
- **(b)** *Limitations regarding certain commodities*
  ...
  - **(3)** *Covered agricultural commodities* Paragraphs (1) and (2) apply to the following agricultural commodities:
    ...
    - **(C)** Wild rice.
- **(c)** *Exceptions* Paragraphs (1) and (2) of subsection (b) of this section shall not limit the planting of an agricultural commodity specified in paragraph (3) of that subsection—
