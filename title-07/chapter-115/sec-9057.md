...
- **(b)** *Premium per hundredweight for first 4 million pounds of production*
  ...
  - **(2)** *Producer premiums* Except as provided in paragraph (3), the following annual premiums apply: Coverage LevelPremium per Cwt. $4.00None $4.50$0.010 $5.00$0.025 $5.50$0.040 $6.00$0.055 $6.50$0.090 $7.00$0.217 $7.50$0.300 $8.00$0.475
...
- **(c)** *Premium per hundredweight for production in excess of 4 million pounds*
  - **(1)** *In general* For milk marketings in excess of 4,000,000 pounds included in the production history of a participating dairy operation, the premium per hundredweight for each coverage level is specified in the table contained in paragraph (2).
