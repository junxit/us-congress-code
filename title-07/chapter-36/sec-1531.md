...
- **(b)** *Supplemental revenue assistance payments*
  ...
  - **(4)** *Farm revenue*
    - **(A)** *In general* For purposes of this subsection, the total farm revenue for a farm,11 So in original. The comma probably should not appear. shall equal the sum obtained by adding—
      ...
      - **(ii)** 15 percent of amount of any direct payments made to the producer under sections 1103 and 1303 22 See References in Text note below. of the Food, Conservation, and Energy Act of 2008 [7 U.S.C. 8713, 8753] or successor sections;
