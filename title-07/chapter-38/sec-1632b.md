...
- **(f)** *Use of funds* An eligible entity to which a grant is made under the Program may use the grant only for the following purposes (but only to the extent that the use is not described in section 1632a(d) of this title):
  - **(1)** Applied research.
