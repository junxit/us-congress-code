...
- **(a)** *In general*
  - **(1)** *Authorization* The President may sell to an eligible country up to 40 percent of such country’s qualified debt, only if an amount of the local currency of such country (other than the price paid for the debt) equal to—
