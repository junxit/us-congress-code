...
- **(b)** *Votes permitted*
  ...
  - **(2)** *Eligible separate facility* For the purpose of paragraph (1):
    ...
    - **(C)** *Annual sales determined* For the purpose of determining the amount of annual sales of cut flowers and cut greens under subparagraph (B), subparagraphs (A) and (C) of section 6802(4) of this title shall apply.
