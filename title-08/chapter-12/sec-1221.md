...
- **(c)** *Contents of manifest* The information to be provided with respect to each person listed on a manifest required to be provided under subsection (a) or (b) of this section shall include—
  - **(1)** complete name;
  - **(2)** date of birth;
  - **(3)** citizenship;
  - **(4)** sex;
...
- **(e)** *Deadline for requirement of electronic transmission of manifest information* Not later than January 1, 2003, manifest information required to be provided under subsection (a) or (b) of this section shall be transmitted electronically by the appropriate official specified in subsection (d) of this section to an immigration officer.
