...
- **(c)** *Penalties relating to vessels and aircraft*
  - **(1)** *Civil penalties*
    - **(A)** *Failure to carry out certain orders* If the Attorney General is satisfied that a person has violated subsection (d) or (e) of section 1231 of this title, the person shall pay to the Commissioner the sum of $2,000 for each violation.
