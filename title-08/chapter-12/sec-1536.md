...
- **(a)** *Upon filing application*
  ...
  - **(3)** *Release if order denied and no review sought*
    - **(A)** *In general* Subject to subparagraph (B), if a judge of the removal court denies the order sought in an application filed pursuant to section 1533 of this title, and the Attorney General does not seek review of such denial, the alien shall be released from custody.
    - **(B)** *Application of regular procedures* Subparagraph (A) shall not prevent the arrest and detention of the alien pursuant to subchapter II of this chapter.
