...
- **(b)** *Transition period* Until such time as the law enforcement and intelligence data system described in section 1722 of this title is fully implemented, the Attorney General shall enter the data described in subsection (a) of this section into an existing data system being used to determine the admissibility or deportability of aliens.
