...
- **(d)** A selection board convened under section 611(a) of this title shall, when authorized under section 616(g) 11 See References in Text note below. of this title, include in its report to the Secretary concerned the names of those officers recommended by the board to be placed higher on the promotion list and the order in which the board recommends that those officers should be placed on the list.
