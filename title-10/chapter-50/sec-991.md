...
- **(a)** *Management Responsibilities.—*
  ...
  - **(4)** The Secretary of Defense shall prescribe a policy that addresses each of the following:
    - **(A)** The amount.11 So in original. The period probably should not appear. of dwell time a regular member of the armed forces or unit remains at the member’s or unit’s permanent duty station or home port, as the case may be, between deployments.
