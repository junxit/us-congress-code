...
- **(a)** *Mental Health Assessments.—*
  ...
  - **(2)** A mental health assessment is not required for a member of the armed forces under subparagraph 11 So in original. Probably should be “subparagraphs”. (B) and (C) of paragraph (1) if the Secretary determines that—
