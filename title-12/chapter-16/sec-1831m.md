...
- **(g)** *Improved accountability*
  ...
  - **(4)** *Enforcement actions*
    - **(A)** *In general* In addition to any authority contained in section 1818 of this title, the Corporation or an appropriate Federal banking agency may remove, suspend, or bar an independent public accountant, upon a showing of good cause, from performing audit services required by this section.
