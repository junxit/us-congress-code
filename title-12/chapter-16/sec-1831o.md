...
- **(g)** *More stringent treatment based on other supervisory criteria*
  - **(1)** *In general* If the appropriate Federal banking agency determines (after notice and an opportunity for hearing) that an insured depository institution is in an unsafe or unsound condition or, pursuant to section 1818(b)(8) of this title, deems the institution to be engaging in an unsafe or unsound practice, the agency may—
...
- **(k)** *Reviews required when Deposit Insurance Fund incurs losses*
  ...
  - **(4)** *Public disclosure required*
    - **(A)** *In general* The appropriate Federal banking agency shall disclose any report on losses required under this subsection, upon request under section 552 of title 5 without excising—
