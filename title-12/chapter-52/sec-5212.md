...
- **(a)** *Authority*
  - **(1)** *In general* If the Secretary establishes the program authorized under section 5211 of this title, then the Secretary shall establish a program to guarantee troubled assets originated or issued prior to March 14, 2008, including mortgage-backed securities.
...
- **(c)** *Premiums*
  ...
  - **(4)** *Adjustment to purchase authority* The purchase authority limit in section 5225 of this title shall be reduced by an amount equal to the difference between the total of the outstanding guaranteed obligations and the balance in the Troubled Assets Insurance Financing Fund.
