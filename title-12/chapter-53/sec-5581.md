...
- **(c)** *Authorities of the prudential regulators*
  ...
  - **(2)** *Enforcement*
    - **(A)** *Limitation* The authority of a transferor agency that is a prudential regulator to enforce compliance with Federal consumer financial laws with respect to a person described in section 5515(a) of this title, shall be limited to the backup and enforcement procedures in 22 So in original. The word “in” probably should not appear. described in section 5515(c) of this title.
