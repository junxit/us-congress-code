...
- **(i)** *Certification required*
  ...
  - **(3)** *Penalties*
    ...
    - **(B)** *Criminal penalty*
      - **(i)** *In general* Any person that knowingly submits a certification pursuant to paragraph (1) that is false shall be subject to the criminal penalties set forth under section 1001 of title 18.
