...
- **(c)** *Payments to States*
  - **(1)** *Full reimbursement* There shall be paid to each State which has entered into an agreement under this section an amount equal to 100 percent of—
...
- **(d)** *Funding*
  ...
  - **(2)** *Administrative expenses*
    - **(A)** *In general* Funds in the employment security administration account (as established by section 1101(a) of title 42) of the Unemployment Trust Fund (as established by section 1104(a) of title 42) shall be used to make payments to States pursuant to subsection (c)(1)(B).
