...
- **(a)** *In general*
  ...
  - **(5)** *Grants to conditionally approved companies*
    - **(A)** *In general* Subject to subparagraphs (B) and (C), upon the request of a company conditionally approved under section 690c(c) of this title, the Administrator shall make a grant to the company under this subsection.
