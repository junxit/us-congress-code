...
- **(b)** *Approval or disapproval* Within 180 days following submission of an application under subsection (a) of this section, the Administrator shall approve or disapprove the application. The Administrator may approve the application only if, after notice and after opportunity for public hearing, the Administrator finds that—
