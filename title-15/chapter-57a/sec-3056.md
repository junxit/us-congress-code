...
- **(c)** *Activities* The following activities shall be carried out under the racetrack safety program:
  ...
  - **(2)** *Standards for safety and performance accreditation*
    - **(A)** *In general* Not later than 120 days before the program effective date, the Authority, in consultation with the racetrack safety standing committee, shall issue, by rule in accordance with section 3053 of this title—
