...
- **(c)** *Recessed lighting fixtures* In carrying out the policy set forth in section 205b of this title (with particular emphasis on the policy set forth in paragraph (2) of that section) a Federal agency may require that specifications for the acquisition of structures or systems of recessed lighting fixtures be expressed under the metric system of measurement, but may not incorporate specifications, that can only be satisfied by hard-metric versions of recessed lighting fixtures, in a solicitation for design or construction of a Federal facility within the United States or its territories unless the head of the agency determines in writing that—
