...
1994—Subsecs. (c) to (e). Pub. L. 103–392, § 402(a), added subsecs. (c) and (d), redesignated former subsec. (c) as (e), and struck out former subsec. (d) which related to overseas services for exporters. Subsecs. (f) to (k). Pub. L. 103–392, § 402(b), added subsecs. (f) to (k).
