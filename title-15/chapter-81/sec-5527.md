...
- **(a)** *Nonapplicability* Except to the extent the appropriate Federal agency or department head determines, the provisions of this chapter shall not apply to—
  ...
  - **(2)** computer systems the function, operation, or use of which are those delineated in paragraphs (1) through (5) of section 2315(a) of title 10.11 So in original. Section 2315 of title 10 does not contain a subsec. (a).
