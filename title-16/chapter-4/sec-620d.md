...
- **(c)** *Civil penalties for violation*
  - **(1)** *Exports*
    ...
    - **(B)**
      - **(i)** Subject to clause (ii), if the Secretary of Commerce finds, on the record and after an opportunity for a hearing, that a person, with willful disregard for the restrictions contained in an order of the Secretary under section 620c(a) of this title on exports of unprocessed timber from public lands, exported or caused to be exported unprocessed timber originating from public lands in violation of such order, the Secretary may assess against such person a civil penalty of not more than $500,000 for each violation, or 3 times the gross value of the unprocessed timber involved in the violation, whichever amount is greater.
...
- **(e)** *Exception* Subsections (c) and (d) of this section do not apply to violations of section 620i of this title.
