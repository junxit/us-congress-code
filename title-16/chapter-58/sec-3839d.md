...
- **(a)** *Limitations* No easement shall be created under this part on land that has changed ownership in the preceding 12 months unless—
...
- **(b)** *Modification; termination*
  - **(1)** *Modification* The Secretary may modify an easement acquired from, or a related agreement with, an owner under this part if—
  ...
  - **(2)** *Termination*
    - **(A)** *In general* The Secretary may terminate an easement created with an owner under this part if—
