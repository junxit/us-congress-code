...
- **(d)** *Land enrolled in other programs*
  - **(1)** *Conservation reserve program* The Secretary may terminate or modify a contract entered into under section 3831(a) of this title if eligible land that is subject to such contract is enrolled in an easement under section 3865c(b) of this title.
