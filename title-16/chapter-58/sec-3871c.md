...
- **(c)** *Payments*
  ...
  - **(3)** *Waiver authority* To assist in the implementation of the program, the Secretary may waive the applicability of the limitation in section 1308–3a of title 7 for participating producers if the Secretary determines that the waiver is necessary to fulfill the objectives of the program.
