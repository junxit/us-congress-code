...
2020—Subsec. (c)(2)(A). Pub. L. 116–188, § 105(1)(A), added cl. (i) and redesignated former cls. (i) and (ii) as (ii) and (iii), respectively. Subsec. (c)(2)(B) to (D). Pub. L. 116–188, § 105(1)(B), (C), added subpar. (B) and redesignated former subpars. (B) and (C) as (C) and (D), respectively. Subsec. (p). Pub. L. 116–188, § 105(2), added subsec. (p).
