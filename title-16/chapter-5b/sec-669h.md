...
- **(a)** *Authorized expenses for administration* Except as provided in subsection (b) of this section, the Secretary of the Interior may use available amounts under section 669c(a)(1) of this title only for expenses for administration that directly support the implementation of this chapter that consist of—
...
- **(b)** *Reporting of other uses*
  - **(1)** *In general* Subject to paragraph (2), if the Secretary of the Interior determines that available amounts under section 669c(a)(1) of this title should be used for an expense for administration other than an expense for administration described in subsection (a) of this section, the Secretary—
