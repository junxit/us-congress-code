...
- **(c)** *Certification*
  - **(1)** The Secretary shall certify a firm (including any agricultural firm or service sector firm) as eligible to apply for adjustment assistance under this part if the Secretary determines—
    ...
    - **(B)** that—
      ...
      - **(ii)** sales or production, or both, of an article or service that accounted for not less than 25 percent of the total sales or production of the firm during the 12-month period preceding the most recent 12-month period for which date 11 So in original. Probably should be “data”. are available have decreased absolutely,
...
- **(d)** *Allowable period for determination* A determination shall be made by the Secretary as soon as possible after the date on which the petition is filed under this section, but in any event not later than 40 days after that date.
