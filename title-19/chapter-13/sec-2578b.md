...
- **(a)** *In general* As used in this part:
  ...
  - **(5)** *International standard* The term “international standard” means a standard, guideline, or recommendation—
    ...
    - **(D)** established by or developed under any other international organization agreed to by the NAFTA countries (as defined in section 2(4) 11 See References in Text note below. of the North American Free Trade Agreement Implementation Act) or by the WTO members (as defined in section 3501(10) of this title).
