...
- **(a)** *Determination*
  - **(1)** *In general* If a positive determination is made under section 4081(b) of this title, the President shall determine whether, as a result of the elimination of a duty under the Agreement, a CAFTA–DR textile or apparel article of a specified CAFTA–DR country is being imported into the United States in such increased quantities, in absolute terms or relative to the domestic market for that article, and under such conditions as to cause serious damage, or actual threat thereof, to a domestic industry producing an article that is like, or directly competitive with, the imported article.
