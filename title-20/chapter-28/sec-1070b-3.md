...
- **(b)** *Allocation of excess based on fair share*
  ...
  - **(2)** For any eligible institution, the excess eligible amount is the amount, if any, by which—
    - **(A)**
      - **(i)** the amount of that institution’s need (as determined under subsection (c) of this section), divided by (ii) the sum of the need of all institutions (as so determined), multiplied by (iii) the amount appropriated pursuant to section 1070b(b) of this title of the fiscal year; exceeds
