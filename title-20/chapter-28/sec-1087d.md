...
- **(c)** *Ineligibility for certain programs based on low earning outcomes*
  - **(1)** *In general* Notwithstanding section 1088(b) of this section, an institution of higher education subject to this subsection shall not use funds under this part for student enrollment in an educational program offered by the institution that is described in paragraph (2).
