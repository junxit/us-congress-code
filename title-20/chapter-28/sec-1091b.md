...
- **(a)** *Return of title IV funds*
  ...
  - **(3)** *Calculation of amount of title IV assistance earned*
    ...
    - **(C)** *Percentage and amount not earned* For purposes of subsection (b), the amount of grant and loan assistance awarded under this subchapter and part C of subchapter I of chapter 34 of title 42 that has not been earned by the student shall be calculated by—
...
- **(b)** *Return of title IV program funds*
  ...
  - **(2)** *Responsibility of the student*
    ...
    - **(B)** *Special rule* The student (or parent in the case of funds due to a loan borrowed by a parent under part B or C) shall return or repay, as appropriate, the amount determined under subparagraph (A) to—
