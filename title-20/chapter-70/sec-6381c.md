...
- **(b)** *Federal share limitation*
  - **(1)** *In general*
    ...
    - **(B)** *Remaining cost* The remaining cost of a program assisted under this subpart may be provided in cash or in kind, fairly evaluated, and may be obtained from any source, including other Federal funds under this chapter.
...
- **(c)** *Use of funds for family literacy services*
  ...
  - **(2)** *Priority* In carrying out paragraph (1), a State educational agency shall give priority to programs that were of low quality, as evaluated based on the indicators of program quality developed by the State educational agency under section 6381i of this title.
