...
- **(a)** *Grants authorized*
  - **(1)** *In general* From amounts made available under section 6533 of this title for a fiscal year, the Secretary shall award grants, on a competitive basis, to eligible entities to enable those entities to carry out the authorized activities described in subsection (d) of this section.
...
- **(c)** *Priority* In awarding grants under this section, the Secretary shall give priority to an eligible entity that submits an application under subsection (b) of this section that—
...
- **(f)** *Data collection and reporting*
  - **(1)** *Data collection* Each eligible entity awarded a grant under this section shall, with respect to each advanced placement subject, annually report to the Secretary on—
    ...
    - **(D)** demographic information regarding individuals served by such agency who taking 11 So in original. advanced placement courses and tests in that subject disaggregated by race, ethnicity, sex, English proficiency status, and socioeconomic status.
