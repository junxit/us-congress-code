...
- **(b)** *Contents* Each application submitted under this section shall be based on the needs assessment required in subsection (c) of this section and shall include the following:
  - **(1)**
