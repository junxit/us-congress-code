...
- **(d)** *Application*
  - **(1)** *In general* To be eligible to receive a grant under this section, an entity described in subsection (b) of this section shall submit an application to the Secretary at such time, in such manner, and containing such information as the Secretary may require.
...
- **(i)** *Period of service* A program participant in a program under this division who receives training through the program shall serve a high-need school operated by a high-need local educational agency for at least 3 years.
...
- **(k)** *Administrative funds* No entity that receives a grant under this section shall use more than 5 percent of the funds made available through the grant for the administration of a program under this division carried out under the grant.
