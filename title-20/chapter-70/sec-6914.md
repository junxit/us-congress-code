...
- **(a)** *In general*
  - **(1)** *Secretary* To receive a grant under this subpart, an eligible entity described in section 6912 or 6913 of this title shall submit an application to the Secretary at such time, in such form, and containing such information as the Secretary may require.
...
- **(g)** *Contents*
  ...
  - **(2)** *Additional information* Each application for a grant under section 6913 of this title shall—
    - **(A)** describe—
