...
- **(a)** *In general* In order to receive an allotment under section 7111(b) of this title for any fiscal year, a State shall submit to the Secretary, at such time as the Secretary may require, an application that—
...
- **(b)** *Interim application*
  ...
  - **(3)** *Exception* A State may not receive a grant under this subpart for a fiscal year after fiscal year 2002 unless the Secretary has approved such State’s application and comprehensive plan as described in subsection (a) of this section.
- **(c)** *Approval process*
