...
- **(b)** *Per-pupil facilities aid programs*
  ...
  - **(2)** *Grants*
    - **(A)** *In general* From the amount made available to carry out this subsection under paragraphs (2) and (3)(B) of section 7221j(b) of this title for any fiscal year, the Secretary shall make grants, on a competitive basis, to States to pay for the Federal share of the cost of establishing or enhancing, and administering per-pupil facilities aid programs.
  ...
  - **(3)** *Use of funds*
    ...
    - **(C)** *Supplement, not supplant* Funds made available under this subsection shall be used to supplement, and not supplant, State and local public funds expended to provide per pupil 11 So in original. Probably should be “per-pupil”. facilities aid programs, operations financing programs, or other programs, for charter schools.
  - **(4)** *Requirements*
  ...
  - **(6)** *Priorities* In making grants under this subsection, the Secretary shall give priority to States that meet the criteria described in paragraph (2), and subparagraphs (A), (B), and (C) of paragraph (3), of section 7221a(e) of this title.
- **(c)** *Rule of construction* Nothing in this section shall be construed to require charter schools to collect any data described in subsection (a) of this section.
