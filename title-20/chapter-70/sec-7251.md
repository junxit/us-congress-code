...
- **(c)** *Requirements of contract* Any contract entered into under subsection (b) of this section shall contain each of the following:
...
- **(e)** *Special rules for certain subcontractors*
  ...
  - **(2)** *Waiver authority* Notwithstanding subsection (c) of this section, the contractor may waive, in whole or in part, the requirement in subsection (c)(1) of this section for a subcontractor, if the subcontractor demonstrates that it would otherwise not be able to participate in the program, and enters into an agreement with the contractor with respect to the amount of the non-Federal share to which the waiver will apply. In a case in which such a waiver is granted, the requirement in subsection (c)(2) of this section shall not apply.
