...
- **(a)** *Submission* Each eligible entity that desires to receive a grant under section 7255b of this title shall submit an application to the Secretary, at such time, in such manner, and containing or accompanied by such information as the Secretary may reasonably require.
- **(b)** *Contents* An application submitted under subsection (a) of this section shall include each of the following:
...
- **(c)** *Approval* In approving applications submitted under subsection (a) of this section for grants under section 7255b of this title, the Secretary shall—
