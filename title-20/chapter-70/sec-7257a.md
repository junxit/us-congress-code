...
- **(a)** *General application*
  - **(1)** *In general* To be eligible to receive a grant under section 7257(a) of this title, a nonprofit telecommunications entity, or partnership of such entities shall submit an application to the Secretary. Each such application shall—
  ...
  - **(2)** *Sites* In approving applications under paragraph (1), the Secretary shall ensure that the program authorized by section 7257(a) of this title is conducted at elementary school and secondary school sites throughout the United States.
- **(b)** *Programming application* To be eligible to receive a grant under section 7257(b) of this title, an entity shall submit an application to the Secretary at such time, in such manner, and accompanied by such information as the Secretary may reasonably require.
