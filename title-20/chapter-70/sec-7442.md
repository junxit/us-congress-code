...
- **(b)** *Eligible entities* For the purpose of this section, the term “eligible entity” means—
  ...
  - **(4)** a Bureau-funded school (as defined in section 2026 11 See References in Text note below. of title 25).
- **(c)** *Program authorized* The Secretary is authorized to award grants to eligible entities having applications approved under this section to enable those entities to carry out the activities described in subsection (d) of this section.
