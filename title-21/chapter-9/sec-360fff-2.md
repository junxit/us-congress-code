---
identifier: /us/usc/t21/s360fff–2
title: 21
chapter: 9
section: 360fff–2
---
...
- **(a)** *Eligibility determinations*
  - **(1)** *In general* Not later than 60 calendar days after the date of receipt of a request under section 360fff–1 of this title, the Secretary shall—
...
- **(b)** *Data submission and filing of requests*
  ...
  - **(3)** *Refusal to file a request*
    - **(A)** *Request for meetings; submission of additional data or other information* If the Secretary refuses to file a request made under section 360fff–1 of this title, the sponsor may—
