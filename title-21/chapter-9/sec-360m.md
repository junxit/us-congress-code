...
- **(b)** *Accreditation*
  ...
  - **(2)** *Accreditation*
    ...
    - **(D)** *Annual report* The Secretary shall include in the annual report required under section 393(g) of this title the names of all accredited persons and the particular activities under subsection (a) of this section for which each such person is accredited and the name of each accredited person whose accreditation has been withdrawn during the year.
...
- **(c)** *Duration* The authority provided by this section terminates October 1, 2017.
