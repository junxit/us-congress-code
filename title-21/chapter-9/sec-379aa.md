...
- **(c)** *Submission of reports*
  - **(1)** *Timing of reports* The responsible person shall submit to the Secretary a serious adverse event report no later than 15 business days after the report is received through the address or phone number described in section 352(x) of this title.
...
- **(e)** *Maintenance and inspection of records*
  ...
  - **(2)** *Records inspection*
    - **(A)** *In general* The responsible person shall permit an authorized person to have access to records required to be maintained under this section, during an inspection pursuant to section 374 of this title.
