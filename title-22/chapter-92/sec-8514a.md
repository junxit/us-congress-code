...
- **(c)** *Application of sanctions*
  - **(1)** *In general* Subject to paragraph (2), the President shall impose sanctions described in section 8514(c) of this title with respect to a person on the list required by subsection (b).
