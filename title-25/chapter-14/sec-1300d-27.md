...
- **(b)** *Jurisdiction and venue*
  ...
  - **(2)** *Consolidation of actions* After the filing of a first action under subsection (a), all other actions subsequently filed under that subsection shall be consolidated with that first action.
  - **(3)** *Jurisdiction by the United States Court of Federal Claims* If appropriate, the United States Court of Federal Claims shall have jurisdiction over an action referred to in subsection (a).
