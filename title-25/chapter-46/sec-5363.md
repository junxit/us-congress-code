...
- **(m)** *Other provisions*
  ...
  - **(3)** *Base budget*
    - **(A)** *In general* A funding agreement shall, at the option of the Indian Tribe, provide for a stable base budget specifying the recurring funds (which may include funds available under section 5325(a) of this title) to be transferred to the Indian Tribe, for such period as the Indian Tribe specifies in the funding agreement, subject to annual adjustment only to reflect changes in congressional appropriations.
