...
- **(a)** *Proposed plan*
  - **(1)** *Submission* After the date on which an Indian tribe receives a notice from the Secretary under section 5612(b)(2) of this title, the Indian tribe shall submit to the Secretary a proposed Indian trust asset management plan in accordance with paragraph (2).
