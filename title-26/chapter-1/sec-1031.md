...
- **(h)** *Special rules for foreign real and personal property* For purposes of this section—
  ...
  - **(2)** *Personal property*
    - **(A)** *In general* Personal property used predominantly within the United States and personal property used predominantly outside the United States are not property of a like kind.
    ...
    - **(D)** *Special rule for certain property* Property described in any subparagraph of section 168(g)(4) shall be treated as used predominantly in the United States.
