...
- **(f)** *Rules for application of section 213* For purposes of section 213(a) (relating to medical, dental, etc., expenses) amounts excluded from gross income under subsection (c) or (d) shall not be considered as compensation (by insurance or otherwise) for expenses paid for medical care.
