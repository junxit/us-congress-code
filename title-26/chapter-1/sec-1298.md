...
- **(d)** *Treatment of certain leased property* For purposes of this part—
  ...
  - **(2)** *Amount taken into account*
    - **(A)** *In general* The amount taken into account under section 1296(a)(2) 1 with respect to any asset to which paragraph (1) applies shall be the unamortized portion (as determined under regulations prescribed by the Secretary) of the present value of the payments under the lease for the use of such property.
...
- **(e)** *Special rules for certain intangibles* For purposes of this part—
  ...
  - **(2)** *Certain licensed intangibles*
    ...
    - **(B)** *Exceptions* Subparagraph (A) shall not apply to—
      ...
      - **(ii)** any payments under a license if a principal purpose of entering into such license was to avoid the provisons 22 So in original. Probably should be “provisions”. of this part.
