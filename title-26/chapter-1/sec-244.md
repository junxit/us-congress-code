...
- **(a)** *General rule* In the case of a corporation, there shall be allowed as a deduction an amount computed as follows:
...
- **(b)** *Exception* If the dividends described in subsection (a)(1) are qualifying dividends (as defined in section 243(b)(1), but determined without regard to section 243(d)(4))—
