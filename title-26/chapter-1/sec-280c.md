...
- **(g)** *22 Another subsec. (g) is set out after subsec. (h). Credit for health insurance premiums* No deduction shall be allowed for the portion of the premiums paid by the taxpayer for coverage of 1 or more individuals under a qualified health plan which is equal to the amount of the credit determined for the taxable year under section 36B(a) with respect to such premiums.
...
- **(g)** *33 Another subsec. (g) is set out before subsec. (h). Qualifying therapeutic discovery project credit*
