...
- **(b)** *Limitation based on modified adjusted gross income*
  ...
  - **(2)** *Modified adjusted gross income* For purposes of subparagraph (A),11 So in original. Probably should be “paragraph (1),”. the term “modified adjusted gross income” means the adjusted gross income of the taxpayer for the taxable year increased by any amount excluded from gross income under section 911, 931, or 933.
