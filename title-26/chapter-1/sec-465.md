...
- **(c)** *Activities to which section applies*
  ...
  - **(6)** *Definitions relating to paragraphs (4) and (5)* For purposes of paragraphs (4) and (5)—
    ...
    - **(C)** *Controlled group of corporations; component member* The terms “controlled group of corporations” and “component members” have the same meanings as when used in section 1563. The determination of the taxable years taken into account with respect to any controlled group of corporations shall be made in a manner consistent with the manner set forth in section 1563.
