...
- **(d)** *Exception for certain leases* This section shall not apply to any lease of property which meets the requirements of all of the following paragraphs:
  ...
  - **(2)** *Lessor must make substantial equity investment*
    ...
    - **(B)** *Risk of loss* For purposes of clause (ii),11 So in original. Probably should be “subparagraph (A)(ii)”. the fair market value at the end of the lease term shall be reduced to the extent that a person other than the lessor bears a risk of loss in the value of the property.
