...
- **(a)** *Certain requirements must be met in the case of organizations described in paragraph (9) or (20) of section 501(c)*
  - **(1)** *Voluntary employees’ beneficiary associations, etc.* An organization described in paragraph (9) or (20) 11 See References in Text note below of subsection (c) of section 501 which is part of a plan shall not be exempt from tax under section 501(a) unless such plan meets the requirements of subsection (b) of this section.
...
- **(c)** *Requirement that organization notify Secretary that it is applying for tax-exempt status*
  - **(1)** *In general* An organization shall not be treated as an organization described in paragraph (9), (17), or (20) 1 of section 501(c)—
