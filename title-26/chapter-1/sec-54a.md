...
- **(d)** *Qualified tax credit bond* For purposes of this section—
  ...
  - **(5)** *Maturity limitation*
    - **(A)** *In general* An issue shall be treated as meeting the requirements of this paragraph if the maturity of any bond which is part of such issue does not exceed the maximum term determined by the Secretary under subparagraph (B).
