...
- **(b)** *Taxable year*
  ...
  - **(5)** *Application with other sections* Except as provided in regulations, for purposes of determining the taxable year to which a partnership is required to change by reason of this subsection, changes in taxable years of other persons required by this subsection, section 441(i), section 584(h),11 See References in Text note below. section 644, or section 1378(a) shall be taken into account.
