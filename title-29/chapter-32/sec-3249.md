...
- **(g)** *Program year*
  ...
  - **(2)** *Availability*
    ...
    - **(B)** *Certain national activities*
      - **(i)** *In general* Funds obligated for any program year for any program or activity carried out under section 3224 of this title shall remain available until expended.
