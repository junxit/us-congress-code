...
- **(a)** *Project deauthorization*
  ...
  - **(3)** *Calculation* In calculating the time period under paragraph (1), the Secretary shall not include any period of time during which the project is being reviewed and awaiting determination by the Secretary to implement a locally preferred plan for that project under section 701b–15(a) of this title.
