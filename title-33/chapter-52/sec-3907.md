...
- **(b)** *Selection criteria*
  ...
  - **(3)** *Special rule for certain combined projects* For a project described in section 3905(8) of this title, the Administrator shall only consider the criteria described in subparagraphs (B) through (K) of paragraph (2).
