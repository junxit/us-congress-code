...
- **(c)** *Allocation for State governments*
  - **(1)** *In general* Of the amounts allocated under subsection (b)(1), each State may retain for the purposes described in section 10152 of this title an amount that bears the same ratio of—
...
- **(d)** *Allocations to local governments*
  - **(1)** *In general* Of the amounts allocated under subsection (b)(2), grants for the purposes described in section 10152 of this title shall be made directly to units of local government within each State in accordance with this subsection, subject to subsection (e).
  - **(2)** *Allocation*
