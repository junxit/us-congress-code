...
- **(f)** *Nonprofit requirements*
  - **(1)** *Prohibition* A nonprofit organization that holds money in offshore accounts for the purpose of avoiding the tax described in section 511(a) of title 26, shall not be eligible to receive, directly or indirectly, any funds from a covered grant program.
