...
- **(e)** *Limitations and Exceptions.—*
  ...
  - **(5)** *University exception.—*
    - **(A)** *In general.—* A person commercially using subject matter to which subsection (a) applies may not assert a defense under this section if the claimed invention with respect to which the defense is asserted was, at the time the invention was made, owned or subject to an obligation of assignment to either an institution of higher education (as defined in section 101(a) of the Higher Education Act of 1965 (20 U.S.C. 1001(a)),11 So in original. Another closing parenthesis probably should precede the comma. or a technology transfer organization whose primary purpose is to facilitate the commercialization of technologies developed by one or more such institutions of higher education.
