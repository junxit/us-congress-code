...
2016—Subsec. (b)(8). Pub. L. 114–287 added par. (8). 2007—Subsec. (b)(7). Pub. L. 110–140, § 323(a), added par. (7). Subsecs. (f) to (h). Pub. L. 110–140, § 323(b), added subsec. (f) and redesignated former subsecs. (f) and (g) as (g) and (h), respectively.
