...
- **(a)** *Reports*
  - **(1)** *Collection of information by States*
    ...
    - **(B)** *Required information* The information required under this subparagraph shall include, with respect to a family unit receiving assistance under this subchapter information concerning—
      - **(i)** family income;
  ...
  - **(2)** *Annual reports* Not later than December 31, 1997, and every 12 months thereafter, a State described in paragraph (1)(A) shall prepare and submit to the Secretary a report that includes aggregate data concerning—
