...
- **(a)** *Amounts reserved*
  ...
  - **(2)** *Indians 11 So in original. Probably should be “Indian”. tribes*
    - **(A)** *In general* The Secretary shall reserve not less than 2 percent of the amount appropriated under section 9858 of this title in each fiscal year for payments to Indian tribes and tribal organizations with applications approved under subsection (c).
...
- **(b)** *State allotment*
  - **(1)** *General rule* From the amounts appropriated under section 9858 of this title for each fiscal year remaining after reservations under subsection (a), the Secretary shall allot to each State an amount equal to the sum of—
