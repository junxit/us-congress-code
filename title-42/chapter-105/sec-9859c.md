...
- **(b)** *State allotments*
  - **(1)** *General rule* From the amounts appropriated under section 9859a of this title for each fiscal year and remaining after reservations are made under subsection (a), the Secretary shall allot to each State an amount equal to the sum of—
