...
- **(a)** *Grants to eligible entities and other organizations*
  - **(1)** *In general* Not less than 90 percent of the funds made available to a State under section 9905 or 9906 of this title shall be used by the State to make grants for the purposes described in section 9901 of this title to eligible entities.
    ...
    - **(B)** *Qualified charity*
      ...
      - **(iv)** *Minimum expense requirement*
        ...
        - **(II)** *Poverty program expense* For purposes of subclause (I)—
          - **(aa)** In generalThe term “poverty program expense” means any expense in providing direct services referred to in clause (iii).
          - **(bb)** ExceptionsSuch term shall not include any management or general expense, any expense for the purpose of influencing legislation (as defined in section 4911(d) of title 26), any expense for the purpose of fundraising, any expense for a legal service provided on behalf of any individual referred to in clause (iii), any expense for providing tuition assistance relating to compulsory school attendance, and any expense that consists of a payment to an affiliate of the organization.
