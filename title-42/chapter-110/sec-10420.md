...
- **(f)** *Allotment for Indian tribes*
  - **(1)** *In general* Not less than 10 percent of the total amount available under this section for each fiscal year shall be available for grants under the program authorized by section 3796gg–10 of this title.22 So in original. See References in Text note below.
