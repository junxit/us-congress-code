...
- **(b)** *Types of permissible application information* In order to have adequate information upon which to consider an application under section 12585 of this title, the Corporation may require the following information to be provided in an application submitted under subsection (a) of this section:
...
- **(f)** *Special rule for State applicants*
  - **(1)** *Submission by State Commission* The application of a State for approved national service positions or for a grant under section 12571(a) of this title shall be submitted by the State Commission.
