...
- **(e)** *Fines for violating program requirements*
  ...
  - **(2)** *State agencies*
    - **(A)** *In general* The Secretary shall establish criteria by which the Secretary may impose a fine against any State agency administering a program authorized under this chapter or the Child Nutrition Act of 1966 (42 U.S.C. 1771 et seq.) if the Secretary determines that the State agency has—
      - **(i)** failed to correct severe mismanagement of the program;
