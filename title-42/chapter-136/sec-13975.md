  ...
  - **(3)** *Minimum amount*
    ...
    - **(C)** *Underserved populations*
      - **(i)** *Indian tribes.—*
        ...
        - **(II)** *Applicability of part.—* 22 So in original. Probably should be “section”. The requirements of this section shall not apply to funds allocated for the program described in subclause (I).
