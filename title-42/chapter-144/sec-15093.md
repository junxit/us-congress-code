...
- **(c)** *Amount of grants*
  - **(1)** *Grants to States*
    - **(A)** *Federal matching share* From amounts appropriated under section 15101(a) of this title, the Secretary shall pay to each State that has an application approved under section 15094 of this title, for each year of the grant period, an amount that is—
