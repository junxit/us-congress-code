...
- **(a)** *Requirements* Each voting system used in an election for Federal office shall meet the following requirements:
  ...
  - **(4)** *Alternative language accessibility* The voting system shall provide alternative language accessibility pursuant to the requirements of section 1973aa–1a of this title.
...
- **(c)** *Construction*
  ...
  - **(2)** *Protection of paper ballot voting systems* For purposes of subsection (a)(1)(A)(i) of this section, the term “verify” may not be defined in a manner that makes it impossible for a paper ballot voting system to meet the requirements of such subsection or to be modified to meet such requirements.
