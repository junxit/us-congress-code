...
- **(b)** *Technical criteria for clean coal power initiative*
  - **(1)** *Gasification projects*
    - **(A)** *In general* In allocating the funds made available under section 15961(a) of this title, the Secretary shall ensure that at least 70 percent of the funds are used only to fund projects on coal-based gasification technologies, including—
  ...
  - **(2)** *Other projects*
    - **(A)** *Allocation of funds* The Secretary shall ensure that up to 30 percent of the funds made available under section 15961(a) of this title are used to fund projects other than those described in paragraph (1).
    - **(B)** *Technical milestones*
      - **(i)** *Periodic determination*
