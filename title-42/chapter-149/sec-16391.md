...
- **(f)** *11 So in original. There are two subsecs. (f). Annual report* The Secretary shall include in the annual report required under section 16391a(a) of this title—
...
2 So in original. There are two subsecs. (g).
