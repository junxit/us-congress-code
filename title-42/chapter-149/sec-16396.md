...
2022—Subsec. (f). Pub. L. 117–167, § 10724(b), redesignated subsec. (e) relating to authorization of appropriations as (f). Subsec. (h). Pub. L. 117–167, § 10724(a), added subsec. (h). 2020—Subsec. (e). Pub. L. 116–260 added subsec. (e) relating to coordination. Subsecs. (f), (g). Pub. L. 116–260, which directed redesignation of subsecs. (f) and (g) as (g) and (h), respectively, was executed by redesignating subsec. (f) as (g), to reflect the probable intent of Congress. 2007—Subsec. (f). Pub. L. 110–140 added subsec. (f).
