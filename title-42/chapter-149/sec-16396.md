...
2020—Subsec. (e). Pub. L. 116–260 added subsec. (e). Former subsec. (e) redesignated (f) as the probable intent of Congress. Subsecs. (f) to (h). Pub. L. 116–260, which directed redesignation of subsecs. (f) and (g) as (g) and (h), respectively, was executed by redesignating subsecs. (e) and (f) as (f) and (g), respectively, to reflect the probable intent of Congress. 2007—Subsec. (f). Pub. L. 110–140 added subsec. (f).
