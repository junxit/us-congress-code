...
- **(f)** *Secretarial determinations* Any determination made pursuant to subsections 11 So in original. Probably should be singular. (a) or (b) shall be based on findings by the Secretary using the best available data.
