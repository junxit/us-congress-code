...
- **(c)** *Increase in Federal share*
  ...
  - **(3)** *Training, research, and technical assistance* In the case of a grant provided under section 3147 of this title, the Secretary may increase the Federal share above the percentage specified in subsection (a) up to 100 percent of the cost of the project if the Secretary determines that the project funded by the grant merits, and is not feasible without, such an increase.
