...
- **(d)** *Property interests*
  ...
  - **(2)** *Release*
    ...
    - **(B)** *Certain releases*
      - **(i)** *In general* On written request from a recipient of a grant under section 3149(d) of this title, the Secretary shall release, in accordance with this subparagraph, any Federal interest in connection with the grant, if—
      ...
      - **(iii)** *Savings provision* Section 3212 of this title shall continue to apply to a project assisted with a grant under section 3149(d) of this title regardless of whether the Secretary releases a Federal interest under clause (i).
