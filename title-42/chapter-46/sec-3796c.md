...
- **(e)** *Reports on claims under this subchapter*
  ...
  - **(3)** Not later than 2 years after June 2, 2017, and 2 years thereafter, the Comptroller General of the United States shall—
    ...
    - **(B)** submit to Congress a report on the study conducted under subparagraph (A) that includes an assessment of whether the Bureau has provided the information required under subparagraph (B)(ix) of paragraph (2) 11 So in original. Probably means subpar. (I) of par. (2). of this subsection in each report required under that paragraph.
