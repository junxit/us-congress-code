...
- **(a)** *In general* The Attorney General shall make a grant under section 3796ff of this title to carry out the projects described in the application submitted under section 3796ff–1 of this title upon determining that—
...
- **(b)** *Approval* Each application submitted under section 3796ff–1 of this title shall be considered approved, in whole or in part, by the Attorney General not later than 90 days after first received unless the Attorney General informs the applicant of specific reasons for disapproval.
...
- **(e)** *Priority for partnerships with community-based drug treatment programs* In considering an application submitted by a State under section 3796ff–1 of this title, the Attorney General shall give priority to an application that involves a partnership between the State and a community-based drug treatment program within the State.
