...
- **(a)** *In general* A program for which a grant is made under section 3797s(1) of this title shall comply with the following requirements:
...
- **(b)** *Prison-based programs* A program for which a grant is made under section 3797s(2) of this title shall comply with the following requirements:
