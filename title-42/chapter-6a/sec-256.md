...
- **(c)** *Limitations*
  - **(1)** *Number of awards*
    - **(A)** *In general* For each of fiscal years 2003, 2004, 2005, and 2006, the Secretary may not make more than 35 new awards under subsection (a) of this section (excluding renewals of such awards).
  ...
  - **(3)** *Extraordinary circumstances*
    - **(A)** *In general* In paragraph (2), the term “extraordinary circumstances” means an event (or events) that is outside of the control of the eligible entity that has prevented the eligible entity from fulfilling the objectives described by such entity in the application submitted under subsection (b)(2) of this section.
