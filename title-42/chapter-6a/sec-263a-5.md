...
- **(1)**
  - **(A)** 11 So in original. No par. (2) has been enacted. pregnancy success rates reported to the Secretary under section 263a–1(a)(1) of this title and, in the case of an assisted reproductive technology program which failed to report one or more success rates as required under such section, the name of each such program and each pregnancy success rate which the program failed to report, and
