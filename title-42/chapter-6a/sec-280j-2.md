...
- **(c)** *Consultation*
  - **(1)** *In general* In carrying out this section, the Secretary shall consult with the entity with a contract under section 1890(a) of the Social Security Act [42 U.S.C. 1395aaa(a)], and other entities, as appropriate, to determine the type of information that is useful to stakeholders and the format that best facilitates use of the reports and of performance reporting Internet websites.
