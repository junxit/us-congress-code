...
- **(d)** *Scientific Advisory Committee*
  ...
  - **(2)** *Membership*
    ...
    - **(B)** *Nonvoting ex officio members* The membership of the SAC shall, in addition to voting members under subparagraph (A), include as nonvoting ex officio members the agency heads specified in subsection (c) of this section (or their designees).
- **(e)** *Duties* The ICCVAM shall, consistent with the purposes described in subsection (b) of this section, carry out the following functions:
