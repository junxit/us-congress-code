...
- **(e)** *General provisions regarding services of system*
  - **(1)** *Case management services* A funding agreement for a grant under section 290ff(a) of this title is that a system of care under subsection (a) will provide for the case management of each child provided access to the system in order to ensure that—
