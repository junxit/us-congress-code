...
- **(b)** *Duties* The Advisory Committee shall—
  ...
  - **(6)** develop a model decision-matrix for newborn screening expansion, including an evaluation of the potential public health impact, including the cost 11 So in original. Probably should be followed by a comma. of such expansion, and periodically update the recommended uniform screening panel, as appropriate, based on such decision-matrix;
