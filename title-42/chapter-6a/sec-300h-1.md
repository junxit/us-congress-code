...
- **(b)** *State applications; notice to Administrator of compliance with revised or added requirements; approval or disapproval by Administrator; duration of State primary enforcement responsibility; public hearing*
  - **(1)**
    - **(A)** Each State listed under subsection (a) of this section shall within 270 days after the date of promulgation of any regulation under section 300h of this title (or, if later, within 270 days after such State is first listed under subsection (a) of this section) submit to the Administrator an application which contains a showing satisfactory to the Administrator that the State—
