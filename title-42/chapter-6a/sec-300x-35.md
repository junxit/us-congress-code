...
- **(b)** *Allocations for technical assistance, national data base, data collection, and program evaluations*
  - **(1)** *In general*
    ...
    - **(B)** The purpose specified in this subparagraph is the collection of data in this paragraph 11 So in original. The words “is the collection of data in this paragraph” probably should not appear. is carrying out sections 290aa–4 and 300y of this title with respect to substance abuse.
