...
- **(g)** *Special rules*
  ...
  - **(3)** *Rules for periods that begin after January 1* For any specific period described in subparagraph (B), (D), (F), (H), (J), (L), (N), (P), (R), or (T) of paragraph (2), the following applies:
