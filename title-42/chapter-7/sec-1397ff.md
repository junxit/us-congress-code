...
- **(a)** *Initial plan*
  - **(1)** *In general* As a condition of receiving payment under subsection (a) or (g) of section 1397ee of this title, a State shall submit to the Secretary a State child health plan that meets the applicable requirements of this subchapter.
...
- **(d)** *Program operation*
  - **(1)** *In general* The State shall conduct the program in accordance with the plan (and any amendments) approved under subsection (c) and with the requirements of this subchapter.
