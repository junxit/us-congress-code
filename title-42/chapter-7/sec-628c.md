...
- **(b)** *Authority to award grants*
  ...
  - **(2)** *Length of grants*
    - **(A)** *In general* Subject to subparagraph (B), a grant shall be awarded under this section for a period of not less than 2 fiscal years and not more than 5 fiscal years.
...
- **(c)** *Additional requirements*
  - **(1)** *Application* In order for a State to be eligible for a grant under this section, the State shall submit an application, subject to the approval of the Secretary, that includes—
