...
- **(a)** *In general*
  - **(1)** *Allotments to States* For the purpose described in subsection (b), the Secretary shall, for each of fiscal years 2018 through 2023, allot to each State which has transmitted an application for the fiscal year under section 705(a) of this title an amount equal to the product of—
...
- **(f)** *Funding*
  - **(1)** *In general* To carry out this section, there is appropriated, out of any money in the Treasury not otherwise appropriated, $75,000,000 for each of fiscal years 2018 through 2023.
