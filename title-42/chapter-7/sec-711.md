...
- **(j)** *Appropriations*
  ...
  - **(3)** *Availability* Funds made available to an eligible entity under this section for a fiscal year (or portion of a fiscal year) shall remain available for expenditure by the eligible entity through the end of the second succeeding fiscal year after award. Any funds that are not expended by the eligible entity during the period in which the funds are available under the preceding sentence may be used for grants to nonprofit organizations under subsection (h)(2)(B).
...
2014—Subsec. (j)(1)(F). Pub. L. 113–93, § 209(1), added subpar. (F). Subsec. (j)(2), (3). Pub. L. 113–93, § 209(2), inserted “(or portion of a fiscal year)” after “for a fiscal year”.
