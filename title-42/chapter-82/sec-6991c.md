...
- **(f)** *Trust Fund distribution*
  ...
  - **(2)** *Allocation*
    - **(A)** *Process* Subject to subparagraphs (B) and (C), in the case of a State with which the Administrator has entered into a cooperative agreement under section 6991b(h)(7)(A) of this title, the Administrator shall distribute funds from the Trust Fund to the State using an allocation process developed by the Administrator.
