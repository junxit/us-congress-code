...
- **(a)** *Separate affiliate required for competitive activities*
  - **(1)** *In general* A Bell operating company (including any affiliate) which is a local exchange carrier that is subject to the requirements of section 251(c) of this title may not provide any service described in paragraph (2) unless it provides that service through one or more affiliates that—
