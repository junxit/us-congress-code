...
1 So in original. There are two subsecs. designated (g). The first subsec. (g) probably should be designated (f).

2 So in original. There is no subsec. designated subsec. (f).
