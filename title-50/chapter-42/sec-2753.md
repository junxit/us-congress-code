...
- **(a)** *Establishment of cost and schedule baselines*
  - **(1)** *Stockpile life extension and new nuclear weapon program projects*
    ...
    - **(B)** *Per unit cost* The cost baseline developed under subparagraph (A) shall include, with respect to each life extension project,11 See Codification note below. an estimated cost for each warhead in the project.
