...
- **(d)** *Provision of information*
  ...
  - **(2)** *Written notice about reporting requirements* The head of each element of the intelligence community shall provide written notice of the reporting requirements under subsection (b) to an employee when the employee ceases to occupy a covered intelligence position.
