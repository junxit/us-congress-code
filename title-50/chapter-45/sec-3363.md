...
- **(d)** *Report on criteria for information sharing*
  ...
  - **(2)** The report shall include a description of the circumstances in which the Director has determined that sharing information on the list with the departments and agencies of the Federal Government, and of State and local governments, described by subsection (c) of this section would be inappropriate due to the concerns addressed by section 403–3(c)(7) 22 See References in Text note below. of this title, relating to the protection of sources and methods, and any instance in which the sharing of information on the list has been inappropriate in light of such concerns.
